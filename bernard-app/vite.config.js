      ...
      output: {
        codeSplitting: {
          groups: [
            ...
            { test: /\/src\/components\/win95\/(Desktop|DraggableWindow|StartMenu|Mascot|StickyNotes)\.jsx$|\/src\/constants\/wallpapers\.js$/, name: 'desktop-core' },
            { test: /\/src\/components\/win95\/(DatabaseWindow|ArtistSubWindows)\.jsx$/, name: 'desktop-artists' },
            { test: /\/src\/components\/win95\/(CollectifsWindow|LieuxWindow|FestivalsWindow)\.jsx$/, name: 'desktop-network' },
            { test: /\/src\/components\/win95\/(ProjectManager|CalendarWindow|NotePadWindow|DesktopSettings|UniversalSearch|StickyManager|TodoWindow|TrashWindow|ManualWindow|RadioWindow)\.jsx$/, name: 'desktop-tools' },
