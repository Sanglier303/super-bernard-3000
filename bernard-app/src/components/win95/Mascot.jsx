...
const MESSAGES = [
  ...
  "Saviez-vous que la v4.0 introduit le Z-Index Dynamique ? Vos fenêtres actives sont toujours prioritaires !",
  "Besoin d'un tableur ? Allez dans Fichier > Exporter CSV dans vos bases de données.",
  "Le mode Kanban permet de glisser-déposer vos projets entre les colonnes. Essayez !",
  "Vous pouvez lier un projet à un Artiste ou un Lieu spécifique dans le gestionnaire de projets.",
  "L'Agenda affiche vos échéances mensuelles. Cliquez sur un jour pour voir les détails.",
  "Le Gestionnaire Post-it permet de masquer ou de supprimer vos notes flottantes en un clic.",
  "Utilisez la touche 🔍 dans la barre des tâches pour une recherche universelle instantanée.",
  "Rien n'est perdu ! La Corbeille permet de restaurer vos données archivées.",
  "Consultez les statistiques pour voir la répartition par styles musicaux et par zones.",
  "Envie de changer d'air ? Activez la rotation automatique des fonds d'écran dans les paramètres.",
  "Le bouton 🗗 (Show Desktop) à côté de l'horloge réduit toutes vos fenêtres d'un coup !",
  "Faites un clic droit sur le bureau pour fermer ou réduire toutes les fenêtres rapidement.",
  "La Sainte Bible du Super Bernard est disponible dans la fenêtre À propos. Consultez-la !",
